...
Mobile.setText(findTestObject('Object Repository/Search/android.widget.EditText - Search'), 'apple', 0)

Mobile.tap(findTestObject('Object Repository/Search/android.widget.ImageView'), 0)

Mobile.getText(findTestObject('Search/android.widget.EditText - Search'), 0)
